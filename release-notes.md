...
- **Faster return to Games.** The system list stays indexed in memory instead of rescanning the SD card after leaving Recents.
- **Cleaner navigation.** The active tab uses brighter theme text. Inactive tabs are muted. Bottom controls remain separate pillboxes.
