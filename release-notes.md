...
- **Sleep / standby:** TreeFrogUI gives you **true hibernation** instead - **Quick Resume** + **Auto-Save/Auto-Load** boots straight back into your game exactly where you left off, surviving a full power-off with zero battery drain. Stock sleep is **not supported and won't be** (it can hang the display on wake), so Disable Sleep is on by default. You're not missing anything.
